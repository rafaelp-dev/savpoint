...
public class UserGameController {
    ...
    public ResponseEntity<List<UserGameResponse>> listUserGamesByRating(Authentication authentication,
            @PathVariable Integer rating) {
        List<UserGameResponse> games = userGameService.listUserGamesByRating(authentication, rating);
        return ResponseEntity.ok(games);
    }
}
